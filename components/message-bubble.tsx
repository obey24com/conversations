    ...
    >
      ...
      >
        ...
        <div className="mt-3 pr-2">
          ...
          <p
            className={cn(
              "mt-2 text-sm text-gray-600 italic overflow-hidden transition-all duration-500 ease-in-out",
        ...
        >
          <Volume2
            className={cn(
              ...
              isPlaying &&
                "text-blue-500 animate-[wave_2s_ease-in-out_infinite]",
              "hover:scale-110",
            )}
          />
        </Button>
...
index cae3082a3c32b29c2ac84638c1b40b270157213e..d1a1a10020fe0ffaa1608e1bf268fbd2864425dd 100644
...
--- a/components/message-bubble.tsx
+++ b/components/message-bubble.tsx
@@ -119,161 +122,146 @@ export const MessageBubble = memo(function MessageBubble({
           title: "Error",
           description: "Please try sharing again",
           variant: "destructive",
         });
...
-            <Volume2 className={cn(
+      {/* Bottom-centered action buttons */}
+      <div className="absolute left-1/2 -translate-x-1/2 bottom-0 translate-y-full flex gap-2">
+        <Button
+          variant="ghost"
+          size="icon"
+          className="h-9 w-9 bg-white/95 shadow-sm hover:shadow-md transition-all duration-300 backdrop-blur-sm"
